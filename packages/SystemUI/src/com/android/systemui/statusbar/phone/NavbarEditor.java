...
public class NavbarEditor implements View.OnTouchListener {
    ...
    public static final ButtonInfo NAVBAR_NOTIFICATION = new ButtonInfo("notification_drawer",
            R.string.navbar_notification_button, R.string.accessibility_notification_drawer,
            KeyEvent.KEYCODE_NOTIFICATION, R.drawable.ic_sysbar_notification_drawer, R.drawable.ic_sysbar_notification_drawer_land,
            R.drawable.ic_sysbar_notification_drawer_side);
    ...
    private static final ButtonInfo[] ALL_BUTTONS = new ButtonInfo[] {
        ...
        NAVBAR_RECENT, NAVBAR_CONDITIONAL_MENU, NAVBAR_ALWAYS_MENU, NAVBAR_MENU_BIG, NAVBAR_NOTIFICATION, NAVBAR_POWER
    };
